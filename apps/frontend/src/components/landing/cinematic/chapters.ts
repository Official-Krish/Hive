...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    body: "1.84M tokens → 143 tasks → 38 PRs → 17 shipped. Token burn mapped directly to output, per model, per dev, per dollar — and Watchdog flags stuck agents, runaway burn, failing streaks, and budget breaches before they cost you.",
    proof: ["127 tasks today", "agent.stuck · token.burn", "budget alerts"],
  ...
  },
  {
    ...
    body: "OAuth App connect, per-repo webhooks, encrypted tokens. Pushes and PRs land on the floor the second they happen — and a reviewer bot greets every PR with a secret scan and a model pass.",
    proof: [
      "push · pull_request",
      "reviewer bot on every PR",
      "per-repo webhooks",
    ],
