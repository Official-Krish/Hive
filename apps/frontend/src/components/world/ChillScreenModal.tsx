...
export function ChillScreenModal({
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-40 grid place-items-center bg-black/30 p-4 backdrop-blur-[2px]">
      <div className="flex h-[min(80vh,640px)] w-[min(560px,96vw)] flex-col overflow-hidden rounded-2xl bg-[#f4f2ed] ring-1 ring-black/[0.09] shadow-[0_28px_70px_-24px_rgba(0,0,0,0.8)]">
        {/* Header */}
            ...
            {state.videoId ? (
              <div className="mt-1.5 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1.5 rounded-xl bg-neutral-950 px-3.5 py-2 text-[12.5px] font-semibold text-white transition-colors hover:bg-neutral-800 disabled:opacity-40"
                >
                  {state.isPlaying ? (
                    <>
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="shrink-0 rounded-xl bg-neutral-950 px-4 py-2.5 text-[12.5px] font-semibold text-white transition-colors hover:bg-neutral-800 disabled:opacity-40 disabled:hover:bg-neutral-950"
              >
                Play on screen
              </button>
            </div>
